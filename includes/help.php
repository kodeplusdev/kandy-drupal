...
<div>
    <p style="margin-left: 80px;">
        window.loginsuccess_callback = function () {<br />
    ...
    <p style="margin-left: 80px;">
        window.callended_callback = function () {<br />
        &nbsp; &nbsp;<span style="line-height: 20.7999992370605px;">//do something when someone&nbsp;end &nbsp;your call</span><br />
        }
    </p>

    <p style="margin-left: 80px;">
        <span style="line-height: 20.7999992370605px;">window.answerVideoCall_callback = function (stage) {</span><br style="line-height: 20.7999992370605px;" />
        <br />
        <br />
        <span style="line-height: 20.7999992370605px;">&nbsp; &nbsp;&nbsp;</span><span style="line-height: 20.7999992370605px;">//do something when you answer video call</span><br style="line-height: 20.7999992370605px;" />
        <br />
        <br />
        <span style="line-height: 20.7999992370605px;">}</span><br />
        window.answerVoiceCall_callback = function (stage) {<br />
        &nbsp; &nbsp; <span style="line-height: 20.7999992370605px;">//do something when you answer voice call</span><br />
        }
    </p>
    ...
    <p style="margin-left: 80px;">
        <br />
        window.endCall_callback = function (stage) {<br />
    ...
    <p style="margin-left: 80px;">
        window.localvideoinitialized_callback = function(videoTag){<br />
        &nbsp; &nbsp; //do some thing with your local video<br />
        }
    </p>

    <p style="margin-left: 80px;">
        window.presencenotification_callack = function() {<br />
